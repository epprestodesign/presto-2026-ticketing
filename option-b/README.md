...
**The pair:** this is one of two Aug 4 takes on the same brief. The other is **[Option A](../option-a)** (packages-first) — live at https://epprestodesign.github.io/presto-2026-ticketing/option-a/ . Both are documented together under **Aug 4 Changes** in Storybook:
