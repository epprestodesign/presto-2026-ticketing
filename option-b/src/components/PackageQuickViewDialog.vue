<script setup>
// PackageQuickViewDialog — FORK for the "Aug 4 — Option B" prototype.
//
  ...
  <div class="pqv">
    ...
    <div class="pqv__scroll">
      ...
      <div class="pqv__cols">
        ...
        <!-- The choices column. Where you STAY leads — it's the decision this
             screen exists for, and burying it under four tier rows put it below
             the fold. Ticket tier follows, then the written detail. A package
