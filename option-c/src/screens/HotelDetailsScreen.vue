...
import { roomsFor } from '../packages.js'

const AMENITY_KEYS = {
  ritz: ['wifi', 'valet', 'pool', 'restaurant', 'fitness', 'breakfast', 'spa', 'concierge'],
  courtyard: ['wifi', 'parking', 'fitness', 'breakfast', 'laundry'],
}

const ADDRESS = {
  ritz: '10 Avenue de Lafayette, Boston, MA',
  courtyard: '35 Foxborough Blvd, Foxborough, MA',
}
...
const args = computed(() => {
  ...
  return {
    ...
    roomsSubtitle:
      'Rates are for your dates. To book, choose your package on the board in the other tab.',
  }
})
</script>
  ...
  <div class="xhd xhd--readonly">
    <p class="xhd__note">
      ...
      <span>
        ...
        This page is here to help you compare — pick your package, and your room, on the board in
        the other tab.
      </span>
    </p>
