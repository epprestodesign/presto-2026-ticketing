...
<div style={{
  ...
  <a href="https://epprestodesign.github.io/presto-2026-ticketing/option-d/" target="_blank" rel="noreferrer"
    ...
    <div style={{ fontSize: '0.875rem', marginTop: '6px', color: '#fff', opacity: 0.92, flex: 1 }}>Two identical packages, one per hotel — the board is the landing page. View the package, then check out. No dates, no tiers, no filters.</div>
...
a single party-size control in the packages header, sitting beside the two prices it
drives rather than gating the page in front of them.
