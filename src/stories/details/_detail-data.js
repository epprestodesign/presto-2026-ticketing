...
export const hotelBase = {
  ...
  seed: 0,
  about: [
    'In the heart of Lake Buena Vista, this resort is an ideal base for gameday weekends — minutes from the stadium, with top attractions, dining, and shopping just steps away. Relax in a newly renovated room after the game, unwind at the heated pool and full-service spa, or refuel at one of three on-site restaurants. Complimentary premium Wi-Fi, a 24-hour fitness centre, and free scheduled shuttle service round out a stay built for groups and families alike.',
