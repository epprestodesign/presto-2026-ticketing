...
// Ticketmaster event feed), used here as the gameday banner's backdrop.
...
| **Gameday** | 1592×400 | Marketing / landing (Patriots backdrop) |
...
/** Gameday hero (1592×400) — the Patriots event backdrop from the ticketing Event Hero. */
export const Gameday = {
  name: 'Gameday',
  parameters: {
    docs: { description: { story: 'Landing-page hero sized 1592×400 using the bundled New England Patriots event image — the same backdrop the ticketing **Event Hero** renders — with the EventPipe wordmark over the event name and date, so the marketing banner and the event page share one look.' } },
  },
  render: () => ({
