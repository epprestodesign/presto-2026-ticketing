...
const ticketsOnlyCart = { ...buildBundleCart({ event, tier, quantity: 2 }), ...detail }
const ticketsHotelCart = { ...buildBundleCart({ event, tier, quantity: 2, hotel, nights: 1 }), ...detail, savings: 58 }
